...
const categories = reactive({
  'Facial Features': {
    ...
    Emotion: {
      input: '',
      options: ['happy', 'mad', 'sad', 'dreamy', 'tense'],
      showDropdown: false,
    },
  },
  Clothing: {
    ...
    Accessories: {
      input: '',
      color: '',
      options: ['glasses', 'hat', 'necklace', 'bag'],
  ...
  Camera: {
    Angle: {
      input: '',
      options: ['eye-level', 'high angle', 'low angle', 'dutch', 'wide angle', 'overhead', 'close-up'],
      showDropdown: false,
    },
    ShotType: {
      input: '',
      options: ['portrait', 'close-up', 'full body', '3/4 body', 'long shot', 'pov'],
      showDropdown: false,
    },
    Lens: {
      input: '',
      options: ['14mm', '35mm', '50mm', '85mm', '200mm'],
      showDropdown: false,
    },
    Lighting: {
      input: '',
      options: ['natural', 'difussed', 'rim', 'neon side', 'golden hour', 'dark misty', 'before dawn'],
      showDropdown: false,
    },
    ISO: {
      input: '',
      options: ['100', '200', '400', '600', '800', '1600', '3200', '6400', '25600'],
      showDropdown: false,
    },
    ShutterSpeed: {
      input: '',
      options: ['1/2', '1/4', '1/8', '1/15', '1/30', '1/60', '1/125', '1/250', '1/500', '1/1000'],
      showDropdown: false,
    },
    Aperture: {
      input: '',
      options: ['f/1.4', 'f/2.0', 'f/2.8', 'f/4', 'f/5.6', 'f/8.0', 'f/11.0', 'f/16.0', 'f/22.0', 'f/32'],
      showDropdown: false,
    },
    Filter: {
      input: '',
      options: ['Neutral Density', 'Polarizing', 'Infrared', 'Warm', 'Cold', 'Black & White'],
      showDropdown: false,
    },
    Texture: {
      input: '',
      options: ['gritty', 'rough', 'weathered', 'cracked', 'pebbled', 'coarse', 'grainy', 'smooth', 'silky', 'matte'],
      showDropdown: false,
    },
    Camera: {
      input: '',
      options: ['Canon EF 50mm f/1.8 STM Lens', 'Fujifilm Pro 400H', 'Kodak Ektachrome E100'],
      showDropdown: false,
    },
  },
});
